...
import OfferImg from '../offerings/OfferImg.vue';
import OfferInfo from '../offerings/OfferInfo.vue';
...
<template>
    <div>
        <Step linktoPrev="newReq1" linktoNext="newReq3" :prvBtShow="true" :nextBtShow="true" :step2="true"/>
        <div class="sub_content type hidden-overflow">
            <div class="divide offerings_wrap request">
                <!--left content-->
                    ...
                    <div class="items_wrap">
                        ...
                        <div class="item">
                            <ItemBox 
                                ...
                                price="매매 3억 5000" 
                                info="3룸 | 3층 | 82㎡(25)/100㎡(33)" 
                                type="주택" :labels="{label1:'욕실수리', label2:'도배'}"  
                                addr="잠실주공1단지 104동잠실"
                            />
                            <div class="bottom_box">
                                <div class="check_form">
